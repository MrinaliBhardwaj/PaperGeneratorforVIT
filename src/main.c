...
int main(void) {
  ...
  struct pdf_info info = {.creator = "VIT University",
                          .producer = "VIT University",
                          .title = {*pdf_title},
  ...
  pdf_add_text_wrap(pdf, page, "VIT University", 24, 0, PDF_A4_HEIGHT - 40, 0,
                    PDF_BLACK, PDF_A4_WIDTH, PDF_ALIGN_CENTER, NULL);
  pdf_add_text_wrap(pdf, page, "School of Computer Science and Engineering", 16, 0,
                    PDF_A4_HEIGHT - 54, 0, PDF_BLACK, PDF_A4_WIDTH,
                    PDF_ALIGN_CENTER, NULL);
  pdf_add_text_wrap(
      pdf, page, "B. Tech. in Computer Science and Engineering, Semester - VI",
      12, 0, PDF_A4_HEIGHT - 66, 0, PDF_BLACK, PDF_A4_WIDTH, PDF_ALIGN_CENTER,
      NULL);
  pdf_add_text_wrap(pdf, page, "B2/TB2 Data Structures and Algorithms", 12, 0,
